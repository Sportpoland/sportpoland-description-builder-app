                    ...
                    {['text-only', 'image-left', 'image-right'].includes(section.type) && (
                      <div style={{ 
                        ...
                        <button
                          ...
                          style={{
                            padding: '4px 8px',
                            backgroundColor: section.textFormatting.underline ? '#3b82f6' : 'white',
                            color: section.textFormatting.underline ? 'white' : 'black',
                            border: '1px solid #d1d5db',
                            borderRadius: '4px',
                            cursor: 'pointer',
          ...
          <div style={{ padding: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
              {(section.icons || []).map((icon) => (
                <div key={icon.id} style={{ border: '1px solid #e5e7eb', borderRadius: '6px', padding: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    <span style={{ fontSize: '14px', fontWeight: '500', color: '#6b7280' }}>Ikona {icon.id}</span>
                    <button
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <div style={{ textAlign: 'center' }}>
                      {icon.icon ? (
                        <img src={icon.icon} alt="" style={{ width: '64px', height: '64px', objectFit: 'contain' }} />
                      ) : (
                        <div style={{ 
                          width: '64px', 
                          height: '64px', 
